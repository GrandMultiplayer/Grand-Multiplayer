#ifndef __CLIENTAPPRENDERER_H__
#define __CLIENTAPPRENDERER_H__
...
private:
	static CefRefPtr<CefBrowser> m_browser;
public:
	static CefRefPtr<CefBrowser> GetBrowser() { return m_browser; }
private:
