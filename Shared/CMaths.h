...
#define DOUBLE_PI    (3.14159265358979323846 * 2)
...
namespace Math
{
	...
	/*static const CVector3 ConvertRadiansToDegrees(const CVector3 &vecRotation)
	{
	...
	template <typename T>
	static T Lerp(T& start, float fAlpha, T& end)
	{
